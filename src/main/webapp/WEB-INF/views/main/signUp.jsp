         ...
         <form action="/main/signUp" method="post" enctype="multipart/form-data" id="form">
            ...
            <div>
               ...
               <div>
                  ...
                  <input id="phoneck" class="button" type="button" value="인증하기" required="required">
            ...
            <div class="personalInfo">
               <span>
                  <input style="width: 20px;" type="checkbox" id="check" required="required">
                  <label for="check">개인정보 수집 및 이용 동의</label>
                  <span>(필수)</span>
               </span>
               <div class="policy">
                  <p>
