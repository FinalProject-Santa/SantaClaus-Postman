	...
	$(".optionItem").on("click", function(){
		...
		if(document.getElementById(name)){
			...
			shopList.append("<div class='selectedItem'><p>" + name + 
					...
					"</p><div><span><input type='button' id='minus' value='-' disabled='disabled'><input type='text' class='inputQun' value='1' readonly='readonly'><input type='hidden' value='1' name='optionDtoList["+ count + "].option_quantity'><input type='button' id='plus' value='+'></span><span>" + priceWithComma + "</span>원<input type='hidden' value='"+price+"' name='optionDtoList["+ count + "].option_price'><input type='hidden' value='"+price+"'><img src='/resources/image/letter/deleteBtn.JPG' class='deleteItem'><input type='hidden' value='"+name+"' name='optionDtoList["+ count + "].option_name'><input type='hidden' value='"+ img +"' name='optionDtoList["+ count + "].option_img'><span id='"+name+"'</div><br><br>");
			count ++;
		}
	});
